% fprintf('Homework 03 Problem 3 (b)\n\n\n')
% Author: Anant Girdhar
% Date: 2024-10-09
% Simulate wxb controller
...
q0 = [0, 0, 0, 1]';
y0 = [omega0 ; q0];
Y = ode4m_ag(@eulerseqns2, tspan, y0);
...
title('Components of $\underline{q}_{BI}$ - wxb controller - Anant', 'Interpreter', 'latex')
legend('q_1', 'q_2', 'q_3', 'q_4')
set(gca, 'fontsize', 18)
saveas(gcf, 'p3b_q.jpg')
...
title('Components of $\underline{\omega}_B^{BI}$ - wxb controller - Anant', 'Interpreter', 'latex')
legend('\omega_1', '\omega_2', '\omega_3')
set(gca, 'fontsize', 18)
saveas(gcf, 'p3b_angular_velocity.jpg')
...
title('Angular speed - wxb controller - Anant')
set(gca, 'fontsize', 18)
saveas(gcf, 'p3b_angular_speed.jpg')
...
xlabel('time (s)')
ylabel('m_{B_i} (A.m^2)')
title('Commanded magnetic dipole moment for each magnetorquer - wxb controller - Anant')
legend('m_{B_1}', 'm_{B_2}', 'm_{B_3}')
set(gca, 'fontsize', 18)
saveas(gcf, 'p3b_commanded_dipole.jpg')
